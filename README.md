# Introduction, Tools, and Reproducibility
...
## 1. What is Atmospheric Statistics?
...
* **Core libraries:**
  ...
  * `xarray` / `netCDF4` – for gridded and Atmospheric data
...
Atmospheric research requires transparent and reproducible results. The main components are:
...
* *Helsel & Hirsch (2002)* — *Statistical Methods in Water Resources* (for Atmospheric case studies).
...
**Outcome:** By the end of this whole study matterial, every student should be fully equipped to carry out reproducible analyses, version control their work, and understand the context of Atmospheric statistics.
